...
<div style="display:none;" id="myDiv" class="animate-bottom">
	  <div class="header" id="hd">
   	&nbsp&nbsp<img id="img" src="icon.png" width="50px" height="55px"><p id="log">&nbsp<span>Treasure</span>BOX</p>
 &nbsp &nbsp &nbsp <a href="#" id="home">Home</a>
 ...
 <button id="srchbtn" onclick="window.location.href='{{url('semester')}}'">Search</button>
 </div><br><br>
@if(isset(Auth::user()->email))
<p>Welcome {{Auth::user()->email}}</p>
<a href="{{url('treasurebox/logout')}}">Logout</a>
else
<script type="text/javascript">alert('Wrong Login Detail')</script>
@endif
<div id="login" style="display:none">
 ...
 <center><label style="font-size:20px;margin-left:45px;border-bottom:3px solid rgba(56, 215, 38, 0.85);padding-left:15px;padding-right:15px;padding-bottom:4px">Signup</label></center><br><br>
	...
	<form method="POST" id="myform" action="{{URL('treasurebox')}}">
		{{csrf_field()}}
  <label>Name<input type="text" id="name" name="name" placeholder="Enter Your Name" required></label><br><br>
 ...
 <label>Mobile No.<input type="number" id="mob" name="mobile" placeholder="Enter Your Mobile Number" pattern="[789][0-9]{9}" title="wrong mobile number" required></label><br><br>
 <label>Email Id<input type="text" id="email" name="email" placeholder="Enter Your Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="wrong email id" required></label><br><br>
 <label>Password<input type="password" id="p1" name="password" placeholder="Enter Password" required></label><br><br>
 ...
 <form action="{{url('login')}}" method="POST">
 	{{csrf_field()}}
	<label>Email Id<input type="text" placeholder="Enter Your Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="wrong email id"></label><br><br>
 <label>Password<input type="password" placeholder="Enter Password" ></label><br><br>
...
<div class="contents" id="contentsid">
 ...
 <div class="mySlides fade">
  <div class="numbertext"><a onclick="document.getElementById('login_box').style.display='block';document.getElementById('login').style.display='none';document.getElementById('contact').style.display='none';document.getElementById('con').style.display='none';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';">Login to access our services</a></div>
  <img src="scroll1.jpg" style="width:87%;height:460px;border-radius:10px;">
  <div class="text">Now easy to achieve your exam goal</div>
 </div>

 <div class="mySlides fade">
  <div class="numbertext"><a onclick="document.getElementById('login_box').style.display='block';document.getElementById('login').style.display='none';document.getElementById('contact').style.display='none';document.getElementById('con').style.display='none';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';">Login to access our services</a></div>
  <img src="scroll2.jpg" style="width:87%;height:460px;border-radius:10px">
  <div class="text">No burdens of exams anymore</div>
 </div>

 <div class="mySlides fade">
  <div class="numbertext"><a onclick="document.getElementById('login_box').style.display='block';document.getElementById('login').style.display='none';document.getElementById('contact').style.display='none';document.getElementById('con').style.display='none';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';">Login to access our services</a></div>
  <img src="scroll3.jpg" style="width:87%;height:460px;border-radius:10px">
  <div class="text">Your true guider to crack your aim</div>
 </div>
...
<div>
	 ...
	 <a href="#" id="blog" onclick="document.getElementById('login_box').style.display='block';document.getElementById('login').style.display='none';document.getElementById('contact').style.display='none';document.getElementById('con').style.display='none';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';">Login to access study materials</a>


<center><div class="add">
	<img src="add.PNG" width="84%" height="600px" style="opactity:2">
	</div></center><br><br>
<div class="service">
	<center><label12 style="font-size:29px;border-bottom:2px solid rgba(56, 255, 38, 0.85);padding-left:500px;padding-right:500px">Our Services</label12><br><br><br>
	<div class="c"><label style="font-size:25px;border-bottom:2px solid rgba(56, 255, 38, 0.85)">Study Material</label><br><br><label>Easy access to pdf guides and lecture notes of each and every subjects(semester wise) for the CSE students of B.Tech.</label><br><br>
 <br><br><br><br><a href="#" id="home" style="background-color: rgba(56, 255, 38, 0.85)" onclick="document.getElementById('contact').style.display='block';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';document.getElementById('con').style.display='none';">Click here for enquiry</a>
	</div>
	<div class="d"><label style="font-size:25px;border-bottom:2px solid rgba(56, 255, 38, 0.85)">Sample Questions</label><br><br><label>A sample of questions are always helpfull to the students for their preparation of exam.We provide some questions related to popular subjects to have some knowledge about the pattern of the exam questions</label>
		<br><br><br><a href="#" id="home" style="background-color: rgba(56, 255, 38, 0.85)" onclick="document.getElementById('contact').style.display='block';document.getElementById('contentsid').style.filter='blur(3px)';document.getElementById('hd').style.filter='blur(3px)';document.getElementById('con').style.display='none';">Click here for enquiry</a>
	</div>
	<div class="e"><label style="font-size:25px;border-bottom:2px solid rgba(56, 255, 38, 0.85)">Practice for MCQ's</label><br><br><label>We provide a well prepared mcq's questions on each subjects and conduct mcq's test on the same as well</label>
 ...
 <center><div class="about" >
	...
	<div class="bisu"  style="margin-left:0px">
		<div class="item">
	<img src="shavani.JPG" width="260px" height="332px">
 </div></div>
 <div class="mail" style="padding-bottom:5px"><label style="margin:0px;padding-right:8px;font-size:19px;font-family:Lobster Two;letter-spacing:0.9px">&nbsp<img src="mail.png" width="25px" align="top":>&nbsp Shbanidevi@gmail.com</label></div>
 
 <div class="sub">
 	<div class="sos">
     <a href="" target="_blank"><img src="fb icon.png" width="25px" style="padding-bottom:13px"></a>
      <a href="https://www.linkedin.com/in/shbani-thakur-460836167" target="_blank"><img src="linkedin icon.png" width="55px" ></a>
       <a href="" target="_blank"><img src="twiter icon.png" width="55px"></a>
   </div>
 <br><label style="background-color: rgba(3, 185, 248, 0.6);padding:8px">Shavani Devi</label><br><br>
 ...
 <div class="bisu"  style="margin-left:190px">
		<div class="item">
	<img src="aman.JPG" width="250px" height="332px">
 </div></div>
  <div class="mail2" style="padding-bottom:5px"><label style="margin:0px;padding-right:8px;font-size:19px;font-family:Lobster Two;letter-spacing:0.9px">&nbsp<img src="mail.png" align="top" width="25px">&nbsp ad201707@gmail.com</label></div>
 	<div class="sub2">
 		<div class="sos2">
     <a href="" target="_blank"><img src="fb icon.png" width="25px" style="padding-bottom:13px"></a>
      <a href="https://www.linkedin.com/in/aman-a89a8714a" target="_blank"><img src="linkedin icon.png" width="55px" ></a>
       <a href="" target="_blank"><img src="twiter icon.png" width="55px"></a>
       </div>
 <br><label style="background-color: rgba(3, 185, 248, 0.6);padding:8px">Amandeep</label><br><br>
 <label style="background-color: rgba(3, 185, 248, 0.6);padding:8px">Student</label>
   </div>
 </div></center>
